...
if page == "Home":
    ...
    st.image('/workspaces/blank-app-1/starbucks drinks.jpg', caption="Starbucks Drinks")
...
if page == "Data Overview":
    ...
    starbucks = pd.read_csv('/workspaces/blank-app-1/Copy of cleaned_starbucks.csv')
    with tab1:
...
if page == "Final Thoughts":
    ...
    st.image('/workspaces/blank-app-1/photo-of-some-low-calorie-starbucks-beverages-1200x675.jpg')
